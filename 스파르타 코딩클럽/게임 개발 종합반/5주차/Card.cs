...
public class Card : MonoBehaviour
{
    ...
    AudioSource audioSource; // 카드의 AudioSource 컴포넌트를 받을 변수 audioSource
    public AudioClip clip; // 카드 뒤집을 때 재생될 AudioSource 에 넣어줄 AudioClip

    public int idx = 0; // 카드의 그림 정보를 저장할 변수 idx

    void Start()
    {
        audioSource = GetComponent<AudioSource>();  // Card 오브젝트에 붙어 있는 AudioSource 컴포넌트 사용
    }
    ...
    public void OpenCard()
    {
        ...
        audioSource.PlayOneShot(clip); // clip 을 한번만 재생
